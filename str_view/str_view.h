...
/* ATTRIB_PURE has no side effects when given the same arguments with the
   ...
   const * data which may change in between SV_Str_view calls. ATTRIB_CONST
...
#define SV_from(str_literal)                                                   \
    ((SV_Str_view){STR_LITERAL(str_literal), sizeof(str_literal) - 1})
...
SV_API size_t SV_str_bytes(char const *str) ATTRIB_NULLTERM(1) ATTRIB_PURE;
...
SV_API char const *SV_reverse_next(char const *c) ATTRIB_PURE;
...
SV_API size_t SV_npos(SV_Str_view sv) ATTRIB_CONST;
...
/* Returns true if the provided SV_Str_view is empty, false otherwise.
   ...
   found. */
SV_API bool SV_is_empty(SV_Str_view sv) ATTRIB_CONST;
...
SV_API size_t SV_len(SV_Str_view sv) ATTRIB_CONST;
...
SV_API size_t SV_bytes(SV_Str_view sv) ATTRIB_CONST;
...
/* Returns a SV_Str_view of the entirety of the underlying string, starting
   ...
   SV_Str_view code. */
SV_API SV_Str_view SV_extend(SV_Str_view sv) ATTRIB_PURE;
...
/* Returns the standard C threeway comparison between cmp(lhs, rhs)
   ...
   returned if bad input is provided such as a SV_Str_view with a
   NULL pointer field. */
SV_API SV_Order SV_compare(SV_Str_view lhs, SV_Str_view rhs) ATTRIB_PURE;
...
/* Returns true if no further tokens are found and position is at the end
   ...
   terminated. */
SV_API bool SV_end_token(SV_Str_view src, SV_Str_view tok) ATTRIB_PURE;
...
SV_API bool SV_reverse_end_token(SV_Str_view src, SV_Str_view tok) ATTRIB_PURE;
...
SV_API char const *SV_begin(SV_Str_view sv) ATTRIB_PURE;
...
SV_API char const *SV_end(SV_Str_view sv) ATTRIB_PURE;
...
/* Returns the reverse iterator beginning, the last character of the
   ...
   view is returned. */
SV_API char const *SV_reverse_begin(SV_Str_view sv) ATTRIB_PURE;
...
/* The ending position of a reverse iteration. It is undefined
   ...
   with reverse_begin. */
SV_API char const *SV_reverse_end(SV_Str_view sv) ATTRIB_PURE;
...
SV_API char const *SV_pointer(SV_Str_view sv, size_t i) ATTRIB_PURE;
...
SV_API size_t SV_find(SV_Str_view hay, size_t pos,
                      SV_Str_view needle) ATTRIB_PURE;
...
SV_API bool SV_contains(SV_Str_view hay, SV_Str_view needle) ATTRIB_PURE;
...
SV_API SV_Str_view SV_match(SV_Str_view hay, SV_Str_view needle) ATTRIB_PURE;
...
SV_API bool SV_starts_with(SV_Str_view sv, SV_Str_view prefix) ATTRIB_PURE;
...
SV_API SV_Str_view SV_remove_prefix(SV_Str_view sv, size_t n) ATTRIB_PURE;

/* Returns true if a suffix less or equal in length to SV_Str_view is
   present, false otherwise. */
SV_API bool SV_ends_with(SV_Str_view sv, SV_Str_view suffix) ATTRIB_PURE;
...
SV_API SV_Str_view SV_remove_suffix(SV_Str_view sv, size_t n) ATTRIB_PURE;
...
/* Finds the first position of an occurence of any character in set.
   ...
   returns 0. */
SV_API size_t SV_find_first_of(SV_Str_view hay, SV_Str_view set) ATTRIB_PURE;
...
SV_API size_t SV_find_last_of(SV_Str_view hay, SV_Str_view set) ATTRIB_PURE;
...
SV_API size_t SV_find_last_not_of(SV_Str_view hay, SV_Str_view set) ATTRIB_PURE;
